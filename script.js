...
<input type="text" class="form-control col-6" id="inputText" placeholder="Enter a valid Name to check the Nationality">
...
cancel.innerHTML=`<button  onclick="cancelPage()" class="btn btn-danger cancelBtn col-2">Cancel</button>`;
cancel.classList.add("col-12")


container1.append(searchContainer,cancel);
...
//To Search for the nationality based on the name.
...
async function search(){
 ...
 function  displayData(values){
    ...
    //To display the top two countries.

    // card1 to display name,nationality and probability
 ...
 //card2 to display name,nationality and probability
